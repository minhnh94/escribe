...
/** @brief The language to be used for speech recognition and TTS.
    @since 1.3
 
    Applications can set the language that should be used for speech recognition and TTS. The language can 
    only be set prior to the first recording session. The default is the application language.
    The language provided on the session can be overridden by setting the language on the VUI controller.
