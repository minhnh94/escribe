...
/** @brief Alternative speech bar button.
 @since 1.3
    ...
    This property must be set to a valid NUSASpeechView instance to use the speech control.
    The default value is nil; in this case the default speech bar will be used. 
*/
...
//////////////////////////////////////////////////////////////////////////////////////////
/// @name Adding an autotext filter
//////////////////////////////////////////////////////////////////////////////////////////

/** @brief Adds an autotext filter.
    @since 1.2
 
    This message adds an autotext filter. 
